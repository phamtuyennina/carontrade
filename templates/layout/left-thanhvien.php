...
<div class="mm_tv">
	<ul>
        ...
        <li><a class="<?php if($_GET['step']=='tin-da-luu'){echo 'act';} ?>" href="thanh-vien/tin-da-luu">Quản lý tin nháp <span class="mauxam"><?=get_luunhap_byUser(1,$_SESSION['user_w']['id'])?></span></a></li>
        <li><a class="<?php if($_GET['step']=='tin-da-luu'){echo 'act';} ?>" href="javascript:void()">Quản lý tin hết hạn <span class="mauden">0</span></a></li>
				<li><a class="<?php if($_GET['step']=='tin-luu'){echo 'act';} ?>" href="thanh-vien/tin-luu">Quản lý tin đã lưu <span class="mauxam"><?=get_yeuthich_byUser($_SESSION['user_w']['id'])?></span></a></li>
