...
CKEDITOR.editorConfig = function( config ) {
	...
	[
		...
		'/',
		{ name: 'styles', items : [ 'Styles','Format','Font','FontSize','blockquote' ] },
...
CKEDITOR.config.extraPlugins = 'codemirror,googledocs,entities,lineheight,youtube,html5video,bootstrapVisibility,letterspacing';