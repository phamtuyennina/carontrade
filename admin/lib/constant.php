<?php if(!@defined('_lib')) die("Error");
	...
	#========= Thông tin nhân viên ==============
	@define ( _contact_email , "Đang cập nhật thông tin" );
	@define ( _contact_yahoo , "Đang cập nhật thông tin" );
	@define ( _contact_skype , "Đang cập nhật thông tin" );
	@define ( _contact_phone , "Đang cập nhật thông tin" );	
	...
	@define ( _upload_tmp , '../upload/tmp/' );
	@define ( _upload_tmp_l , 'upload/tmp/' );	
