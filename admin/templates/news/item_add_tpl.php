...
<form name="supplier" id="validate" class="form" action="index.php?com=news&act=save&curPage=<?=$_REQUEST['curPage']?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
     ...
     <div class="widget">
       ...
       <div id="info" class="tab_content">
        ...
        <div class="formRow <?php if($_GET['type']=='tro-giup'){echo 'none';} ?>">
			...
			<div class="formRight">
               ...
               <?php if($_GET['type']!='video'){ ?>
                    	<div class="note"> Height:560px | Width:840px  <?=_format_duoihinh_l?> </div>
                	<?php }else{?>
                    	<div class="note"> Height:250px | Width:400px  <?=_format_duoihinh_l?> </div>
                    <?php }?>
			</div>
			<div class="clear"></div>
		</div>
        ...
        <?php if($_GET['type']=='bai-viet'){ ?>
            <div class="formRow">
                ...
                <div class="formRight">
                    ...
                    <div class="note"> Height:125px | Width:125px  <?=_format_duoihinh_l?> </div>
                </div>
                <div class="clear"></div>
            </div>
             <?php if($_GET['act']=='edit'){?>
            <div class="formRow">
                ...
                <div class="mt10"><img src="<?=_upload_tintuc.$item['icon']?>"  alt="NO PHOTO" style="max-width:100px;" /></div>
                </div>
                <div class="clear"></div>
            </div>
            <?php } ?>
        <?php }?>
         <?php if($_GET['type']=='danh-gia' or $_GET['type']=='tin-tuc') { ?>
        	<div class="formRow">
        ...
        <div class="formRow">
            ...
            <div class="formRight">
                <input type="text" value="<?=@$item['link']?>" name="link" title="Link video" class="tipS" />
            </div>
            <div class="clear"></div>
        </div>
        <?php }?>
        ...
        <div class="formRow <?php if($_GET['type']!='tin-tuc' && $_GET['type']!='hoi-dap-ve-xe' && $_GET['type']!='video'){echo 'none';} ?>">
