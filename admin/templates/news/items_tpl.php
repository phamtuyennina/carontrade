  ...
  <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
    <thead>
      <tr>
        ...
        <td class="sortCol"><div>Tên bài viết<span></span></div></td>
         <td class="tb_data_small <?php if($_GET['type']!='tin-tuc' && $_GET['type']!='hoi-dap-ve-xe' && $_GET['type']!='video'){echo 'none';} ?>">Nổi bật</td>
    ...
    <tbody>
       ...
       <td>
        ...
        <td align="center" class="<?php if($_GET['type']!='tin-tuc' && $_GET['type']!='hoi-dap-ve-xe' && $_GET['type']!='video'){echo 'none';} ?>">
