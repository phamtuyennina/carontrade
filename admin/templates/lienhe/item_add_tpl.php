	...
	<div class="widget">
       ...
       <div id="info" class="tab_content">
	        ...
	        <div class="formRow">
				...
				<div class="formRight">
	                <input type="text" name="dienthoai" title="e" id="link" class="tipS" value="<?=@$item['dienthoai']?>" />
				</div>
				<div class="clear"></div>
			</div>
            ...
            <div class="formRow">
				<label>Email</label>
				<div class="formRight">
	                <input type="text" name="email" title="" id="email" class="tipS" value="<?=@$item['email']?>" />
				</div>
				<div class="clear"></div>
			</div>
            <div class="formRow">
				<label>Chủ đề</label>
				<div class="formRight">
	                <input type="text" name="chude" title="" id="chude" class="tipS" value="<?=@$item['chude']?>" />
				</div>
				<div class="clear"></div>
			</div>
           ...
           <div class="formRow">
				<label>Địa chỉ</label>
				<div class="formRight">
	                <input type="text" name="diachi" title="" id="diachi" class="tipS" value="<?=@$item['diachi']?>" />
				</div>
				<div class="clear"></div>
			</div>
