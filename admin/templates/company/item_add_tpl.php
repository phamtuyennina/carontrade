    ...
    <div class="title"><img src="./images/icons/dark/users.png" alt="" class="titleIcon" />
       ...
       <?php } ?>
        ...
        <div class="formRow none">
			...
			<div class="formRight">
				<input type="text" value="<?=@$item['ltieude']?>" name="ltieude" title="Nhập tiêu đề link" class="tipS" />
			</div>
			<div class="clear"></div>
		</div> 
        <div class="formRow none">
			...
			<div class="formRight">
				<input type="text" value="<?=@$item['llink']?>" name="llink" title="Nhập link" class="tipS" />
			</div>
			<div class="clear"></div>
		</div> 
    ...
    <div class="form-editor content-item-map none">
     ...
     <div class="widget">
        ...
        <div class="formRow">
			...
			<div class="formRight">
                <textarea rows="4" cols="" title="Nhập IFrame google maps. " class="tipS" name="googlemap"><?=@$item['googlemap']?></textarea>
			</div>
			<div class="clear"></div>
		</div>
        <div class="formRow">
