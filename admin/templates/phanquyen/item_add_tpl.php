...
<div id="permission-draw"><div class="widget">
	<table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable phanquyen" id="checkAll">
        ...
        <tr class="tr_pquyen">
            ...
            <label><input name="man" type="checkbox" data-act="<?=$data_act_man?>" data-com="<?=$item_com[$i]['com']?>" data-type="<?=$item_com[$i]['type']?>" data-act_cap="<?=$act_cap?>" <?php if(in_array($data_act_man, explode(',',$check_quyen['act'])))echo 'checked="checked"' ?>></label>
           
            </td>
            <td><?php if($item_com[$i]['id']!=92 && $item_com[$i]['id']!=91){ ?><label><input name="add" type="checkbox" data-act="<?=$data_act_add?>" <?php if(in_array($data_act_add, explode(',',$check_quyen['act'])))echo 'checked="checked"' ?>></label> <?php }?></td>
            <td><?php if($item_com[$i]['id']!=92 && $item_com[$i]['id']!=91){ ?><label><input name="edit" type="checkbox"  data-act="<?=$data_act_edit?>" <?php if(in_array($data_act_edit, explode(',',$check_quyen['act'])))echo 'checked="checked"' ?>></label> <?php }?></td>
            ...
            <td><?php if($item_com[$i]['id']!=92 && $item_com[$i]['id']!=91){ ?><label><input name="all" type="checkbox"></label> <?php }?></td>
