            	...
            	<div class="bx_form1 clearfix">
                    ...
                    <div class="tk50">
                        <div class="select_search">
                            ...
                            <select id="kieudang" name="kieudang" class="js-example-responsive1 chonkieudang" data-placeholder="Chọn kiểu dáng">
                                <option></option>
                ...
                <div class="bx_form1 clearfix">
                    <div class="tk50">
                        <div class="select_search">
                            ...
                            <select id="mauxe" name="mauxe" class="js-example-responsive1 chonmauxe" data-placeholder="Chọn mẫu xe">
                                <option></option>
