	...
	<div class="bx_chittiet">
    	<div class="thongtin_u_s">
           ...
           <div class="clearfix">
            	...
            	<p class="u_nguoiban"><a href="<?php if($_SESSION['user_w']['id']==$user_ban['id']){echo 'javascript:void(0)';}else{echo $link;} ?>"><?=getten_user($user_ban['id'])?>(<?=demtongsao_user($user_ban['id'])?> <i class="fa fa-star" aria-hidden="true"></i>)</a></p>
                <p class="u_danhgia">
            ...
            <div class="call_u">
                ...
                <a class="p_cal1" href="javascript:void(0)" data-call="<?=$user_ban['dienthoai']?>">Xem</a>
