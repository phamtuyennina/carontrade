<?php 
	...
	$d->reset();
	$sql = "select id,ten$lang as ten,tenkhongdau,photo from #_news where type='video' and hienthi=1 and noibat=1 order by stt,id desc limit 0,5";
	$d->query($sql);
...
<div class="wap_bx1">
	<div class="wapper">
    	<div class="title_kieudanh_thuonghieu">
        	<p class="text-center">Khám phá <span>Xe đang bán</span></p>
...
<div class="chart_us">
	<div class="wapper">
    	...
    	<div class="row">
        	...
        	<div class="col-xs-6 col-chart text-center t1">
