        ...
        <div class="show_tindadang">
			...
			<?php foreach($items1 as $k => $v){ ?>
            	<div class="b_body clearfix">
                    ...
                    <div class="tenbv text-center"><a  href="javascript:void(0)"><?=$v['ten']?></a></div>
                    <div class="ngaytao text-center"><?=date('d/m/Y',$v['ngaytao'])?></div>
                    <div class="ngaykiemduyet text-center">Chưa rõ</div>
                    <div class="trangthai text-center">Lưu nháp</div>
                    <div class="xoa text-center">
                    	<a href="javascript:void()" onclick="suatin_chitiet(<?=$v['id']?>,'thanh-vien/tin-da-luu')" title="Sửa tin nháp"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                    	<a href="javascript:void()" onclick="xoatin_chitiet(<?=$v['id']?>)" title="Xóa tin"><i class="fa fa-trash" aria-hidden="true"></i></a></div>
                </div>
            <?php }?>
            </div>
            <div class="div_foter">
