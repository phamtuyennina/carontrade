...
$(document).ready(function(){
	$('.title_timkiem').click(function(e) {
        if($(this).next().is(':hidden')){
			$('.title_timkiem').find('i').removeClass('fa-angle-down');
			$('.title_timkiem').find('i').addClass('fa-angle-up');
			$(this).next().slideDown();
		}else{
			$(this).next().slideUp();
			$('.title_timkiem').find('i').removeClass('fa-angle-up');
			$('.title_timkiem').find('i').addClass('fa-angle-down');
		}
    });
...
$(document).ready(function(){
	$('.click_ajax_fr').click(function(e) {
        $('#load_fr').load('ajax/ajax_load.php');
		$('#myModal').modal('show');
    });
