...
$(document).ready(function(e) {
	...
	$('#btn_dangkytv1').click(function(e) {
		...
		if($('#dangnhapthanhvien1 input[name="cmnd"]').val()=='') 
		{
			alert('Vui lòng nhập số chứng minh nhân dân!');
			$('#dangnhapthanhvien1 input[name="cmnd"]').focus();
			return false;
		}
	...
	$('#btn_dangkytv2').click(function(e) {
		...
		if($('#dangnhapthanhvien2 input[name="masothue"]').val()=='') 
		{
			alert('Vui lòng nhập mã số thuế!');
			$('#dangnhapthanhvien2 input[name="masothue"]').focus();
			return false;
		}
