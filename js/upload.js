	...
	$(document).ready(function() {
        ...
        $('#input2').filer({
            ...
            changeInput: '<div class="jFiler-input-dragDrop"><div class="jFiler-input-inner"><div class="jFiler-input-icon"><i class="icon-jfi-cloud-up-o"></i></div><div class="jFiler-input-text"><h3>>Bấm vào đây để chọn hình ảnh muốn đăng !</h3> <span style="display:inline-block; margin: 5px 0">Hoặc</span></div><a class="jFiler-input-choose-btn blue">Browse Files</a></div></div>',
            showThumbs: true,
            appendTo: null,
            theme: "dragdropbox",
            templates: {
